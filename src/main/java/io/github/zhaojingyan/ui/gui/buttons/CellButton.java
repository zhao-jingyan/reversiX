...
public final class CellButton extends Button {
    ...
    public CellButton(int row, int col) {
        ...
        setStyle(
                "-fx-background-radius: 0; -fx-background-insets: 0; -fx-padding: 0; -fx-border-radius: 0; -fx-focus-color: transparent; -fx-faint-focus-color: transparent; -fx-box-shadow: none; -fx-effect: none; -fx-background-color: transparent;");
